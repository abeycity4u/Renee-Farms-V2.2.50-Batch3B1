...
<body class="ruminant-page">
    ...
    <div
    class="d-none"
    id="ruminantExpensesAllocationConfig"
    data-cycles="<?php echo app_attr(json_encode($expenseCycles, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_INVALID_UTF8_SUBSTITUTE)); ?>"
    data-animals="<?php echo app_attr(json_encode($ruminantAnimals, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES | JSON_INVALID_UTF8_SUBSTITUTE)); ?>"
    data-csrf-token="<?php echo app_attr(csrf_token()); ?>"
    data-can-manage="<?php echo $canManageExpenses ? '1' : '0'; ?>"
></div>
<script src="<?php echo BASE_URL; ?><?php echo versioned_asset('/assets/js/ruminant-expenses-allocation.js'); ?>"></script>
 ...
 <script src="<?php echo BASE_URL; ?>/assets/js/edit-modal.js"></script>
    <script src="<?php echo BASE_URL; ?><?php echo versioned_asset('/assets/js/ruminant-expenses.js'); ?>"></script>
</body>
</html>
<?php
if ($pdfRequested) {
