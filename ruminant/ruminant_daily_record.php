                ...
                <div class="card poultry-panel">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body app-calendar-scroll <?php echo ($cycleEnabled && $selectedCycleId === 0) ? 'calendar-legacy' : ''; ?>">
                                <div class="row">
                                    <?php
...
<!--
    ...
    data-selected-cycle-animal-type="<?php echo htmlspecialchars(
